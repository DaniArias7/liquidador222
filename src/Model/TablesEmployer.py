...
class Employerinput:
    def __init__(self, name, id, basic_salary, monthly_worked_days, days_leave, transportation_allowance,
        ...
        self.solidarity_pension_fund = solidarity_pension_fund_contribution_percentage
...
class Employeroutput():
    ...
    def Isequivalent(self, dbneon):
        ...
        """
        return (
            self.name == dbneon.name and
            self.id == dbneon.id and
            self.basic_salary == dbneon.basic_salary and
            self.workdays == dbneon.workdays and
            self.sick_leave == dbneon.sick_leave and
            self.transportation_aid == dbneon.transportation_aid and
            self.dayshift_extra_hours == dbneon.dayshift_extra_hours and
            self.nightshift_extra_hours == dbneon.nightshift_extra_hours and
            self.dayshift_extra_hours_holidays == dbneon.dayshift_extra_hours_holidays and
            self.nightshift_extra_hours_holidays == dbneon.nightshift_extra_hours_holidays and
            self.leave_days == dbneon.leave_days and
            self.percentage_health_insurance == dbneon.percentage_health_insurance and
            self.percentage_retirement_insurance == dbneon.percentage_retirement_insurance and
            self.percentage_retirement_fund == dbneon.percentage_retirement_fund and
            self.devengado == dbneon.devengado and
            self.deducido == dbneon.deducido and
            self.amounttopay == dbneon.amounttopay
        )
